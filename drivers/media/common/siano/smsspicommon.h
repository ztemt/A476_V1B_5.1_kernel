...
#define RX_PACKET_SIZE  		0x8000//0x1000


#define TX_BUFFER_SIZE			0x200
/*
 * for some platform, will set TS package size to (188 * 108) to decrease interrupt times.
 * need change RX_BUFFER_SIZE, but as platform memory limited, need chang NUM_RX_BUFFERS
 * to get enough memory
*/
#define RX_BUFFER_SIZE			(RX_PACKET_SIZE + SPI_PACKET_SIZE + 0x100)//(0x1000 + SPI_PACKET_SIZE + 0x100)
#define NUM_RX_BUFFERS			14//72

#define ZERO_TXFUT_SIZE 		RX_BUFFER_SIZE

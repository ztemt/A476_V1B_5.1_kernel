...
#define CUST_EINT_CMMB_NUM              2
#define CUST_EINT_CMMB_DEBOUNCE_CN      32
#define CUST_EINT_CMMB_TYPE							CUST_EINTF_TRIGGER_LOW
#define CUST_EINT_CMMB_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_ENABLE
...
#define CUST_EINT_SIM1_HOT_PLUG_NUM              8
#define CUST_EINT_SIM1_HOT_PLUG_DEBOUNCE_CN      128
#define CUST_EINT_SIM1_HOT_PLUG_TYPE							CUST_EINTF_TRIGGER_HIGH
#define CUST_EINT_SIM1_HOT_PLUG_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_ENABLE

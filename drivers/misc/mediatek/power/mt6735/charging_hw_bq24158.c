...
static void hw_bc11_done(void)
{
 ...
 static kal_uint32 charging_hw_init(void *data)
 {
    ...
    bq24158_config_interface_liao(0x00,0x80);//0xC0);	//kick chip watch dog

    
   // bq24158_config_interface_liao(0x04,0x1A); //146mA
	#if defined(HIGH_BATTERY_VOLTAGE_SUPPORT)
        bq24158_config_interface_liao(0x06,0x7a); // ISAFE = 1250mA, VSAFE = 4.40V
    #else
...
#endif 			
    	{
    		printk("charging_enable: disable\n");
 ...
 static kal_uint32 charging_set_current(void *data)
 {
	...
	printk("xuqian_test charging current:%d\n", *(kal_uint32 *)data);

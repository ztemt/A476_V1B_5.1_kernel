...
inline static int getAFInfo(__user stDW9718AF_MotorInfo * pstMotorInfo)
{
...
#ifdef LensdrvCM3
inline static int getAFMETA(__user stDW9718AF_MotorMETAInfo * pstMotorMETAInfo)
{
    stDW9718AF_MotorMETAInfo stMotorMETAInfo;
    ...
    if(copy_to_user(pstMotorMETAInfo , &stMotorMETAInfo , sizeof(stDW9718AF_MotorMETAInfo)))
    {
        LOG_INF("copy to user failed when getting motor information \n");
    }
...
unsigned long a_u4Param)
{
    ...
    switch(a_u4Command)
    {
        case DW9718AFIOC_G_MOTORINFO :
            i4RetValue = getAFInfo((__user stDW9718AF_MotorInfo *)(a_u4Param));
        break;
        #ifdef LensdrvCM3
        case DW9718AFIOC_G_MOTORMETAINFO :
            i4RetValue = getAFMETA((__user stDW9718AF_MotorMETAInfo *)(a_u4Param));
        break;
        #endif

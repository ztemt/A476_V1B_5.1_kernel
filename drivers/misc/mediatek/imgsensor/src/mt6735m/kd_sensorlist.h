...
#endif
#if defined(T4KA3_MIPI_RAW_OFILM)
    {T4KA3OFMIPI_SENSOR_ID, SENSOR_DRVNAME_T4KA3OF_MIPI_RAW, T4KA3OF_MIPI_RAW_SensorInit},
#endif
#if defined(OV5670_MIPI_RAW)
    {OV5670MIPI_SENSOR_ID, SENSOR_DRVNAME_OV5670_MIPI_RAW, OV5670_MIPI_RAW_SensorInit},
#endif
#if defined(T4KA3_MIPI_RAW_SUB)
    {T4KA3SUBMIPI_SENSOR_ID, SENSOR_DRVNAME_T4KA3_MIPI_RAW_SUB, T4KA3SUB_MIPI_RAW_SensorInit},
#endif
#if defined(T4KA3_MIPI_RAW_COS)
    {T4KA3COSMIPI_SENSOR_ID, SENSOR_DRVNAME_T4KA3COS_MIPI_RAW, T4KA3COS_MIPI_RAW_SensorInit},
#endif
#if defined(S5K4H5YC_MIPI_RAW_DL)
    {S5K4H5YC_DL_SENSOR_ID, SENSOR_DRVNAME_S5K4H5YC_MIPI_RAW_DL, S5K4H5YC_DL_MIPI_RAW_SensorInit},
#endif
#if defined(S5K4H5YC_MIPI_RAW_SUB_DL)
    {S5K4H5YC_DL_SUB_SENSOR_ID, SENSOR_DRVNAME_S5K4H5YC_MIPI_RAW_SUB_DL, S5K4H5YC_DL_MIPI_RAW_SUB_SensorInit},
#endif
#if defined(S5K4H5YC_MIPI_RAW)
    {S5K4H5YC_SENSOR_ID, SENSOR_DRVNAME_S5K4H5YC_MIPI_RAW, S5K4H5YC_MIPI_RAW_SensorInit},
#endif
#if defined(S5K4H5YC_MIPI_RAW_SUB)
    {S5K4H5YC_SUB_SENSOR_ID, SENSOR_DRVNAME_S5K4H5YC_MIPI_RAW_SUB, S5K4H5YC_MIPI_RAW_SUB_SensorInit},
#endif

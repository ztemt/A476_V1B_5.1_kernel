...
// 	printk("yzb_unlocked akm09911 cmd:0x%x\n", cmd);	
	switch (cmd)
	{
...
//    printk("yzb__akm09911_compat_ioctl arg: 0x%lx, arg32: 0x%p\n",arg, arg32);
...
static int akm09911_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	mt_set_gpio_mode(GPIO61, GPIO_MODE_00);
...
static int __init akm09911_init(void)
{
	...
	i2c_register_board_info(2, &i2c_akm09911, 1);
